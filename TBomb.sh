...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        ...
        toilet -f mono12 -F border Frank_Torido
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           website: https://toridofrank.blogspot.com \e[0m"
    echo -e "\e[4;32m   YouTube: https://youtube.com/channel/UCRpwS0nZSwIm4zCoUszQWcw \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of sms_bombing for more stability."
    echo " "
}
